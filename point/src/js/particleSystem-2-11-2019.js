...
var ParticleSystem = function() {
    ...
    var geometry2 = new THREE.BoxGeometry( radius *1.5, height+6, 13 );
   ...
   material = new THREE.PointsMaterial({ size:0.2, vertexColors: THREE.VertexColors, transparent:true, opacity:0.2});//, opacity:0.3});
