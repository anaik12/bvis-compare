...
var ParticleSystem = function() {
    ...
    self.drawContainment = function() {
        ...
        //             // colors
            ...
            // var colorvalues = [{r:0, g:100, b:50},{r:116, g:100, b:50},{r:223, g:100, b:50}, {r:185, g:100, b:50}, {r:307, g:100, b:50}];
   ...
   material = new THREE.PointsMaterial({ size:0.35, map:sprite, side: THREE.DoubleSide, vertexColors: THREE.VertexColors, transparent:true, opacity:0.7});
    // var material = new THREE.PointsMaterial({ size:0.2, vertexColors: THREE.VertexColors, opacity:0.7, transparent: true});//, opacity:0.3});
    ...
    var geometry2 = new THREE.BoxGeometry( radius *1.5, height+6, 15 );
   ...
   material = new THREE.PointsMaterial({ size:0.35, map:sprite, vertexColors: THREE.VertexColors, transparent:true, opacity:0.2});//, opacity:0.3});
